...
public class  Notlar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tüm Notlar");
        ...
        mcreatenotesfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Notlar.this, NotOlustur.class));
            }
        });

        Query query = firebaseFirestore.collection("notlar").
                document(firebaseUser.getUid()).collection("notlarım").orderBy("title", Query.Direction.ASCENDING);
//degisebilirsin belki
        ...
        noteAdapter = new FirestoreRecyclerAdapter<firebasemodel, NoteViewHolder>(allusernotes) {
            ...
            noteViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                //    Toast.makeText(getApplicationContext(), "tıkladınız", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            popupbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    popupMenu.getMenu().add("Duzenle").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        @Override
                           ...
                           // Toast.makeText(v.getContext(), "Not silindi", Toast.LENGTH_SHORT).show();
                            ...
                            documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(v.getContext(), "Silme hatası", Toast.LENGTH_SHORT).show();
    ...
    public class NoteViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public NoteViewHolder(@NonNull View itemView) {
            ...
            mnote=itemView.findViewById(R.id.not);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            case R.id.cikis:
                ...
                finish();
                startActivity(new Intent(Notlar.this,MainActivity.class));
        }
